...
@Discription: This .py generates intelligences and trains and tests them in the Batch_Sighnatures_5actions.py environment,
...
def get_args():
    ...
    parser.add_argument('--epsilon_decay', default=1500, type=int, help="decay rate of epsilon")
    ...
    parser.add_argument('--invalid_Sig_num', default=300, type=int)
...
def test(cfg, env, agent):
    ...
    for i_ep in range(cfg.test_eps):
        ...
        while True:
            ...
            print("The action value of the {} step of the {}th test is {}".format(i_ep + 1, ep_step + 1, action))
            last_action = action
            last_state = state
            # print("++++++++++", action)
